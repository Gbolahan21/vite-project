  ...
  return (
    <div className="bg-gray-900 h-screen overflow-hidden">
      <header className="absolute inset-x-0 top-0 z-50">
        <nav aria-label="Global" className="flex items-center justify-between p-6 md:py-6 mx-auto max-w-2xl">
      ...
      <div className="relative isolate px-6 pt-14 lg:px-8">
        ...
        <div className="mx-auto max-w-2xl sm:py-20 lg:py-20 py-20">
